...
public class Employee implements Serializable {
    private String name,comp_id,code,fname,lname,mname,email,mobile,mobilecode,location,hierarchy_indexid,hierarchy_id,roleid,rolename,designation,branch,department,supertype;
