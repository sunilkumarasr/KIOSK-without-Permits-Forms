...
public class VisitorEmailModel implements Serializable {
    private Integer result;
    private Float total_counts;
    private String incomplete_data;
    private ArrayList<UserDetailsData>items;
    ...
    public ArrayList<UserDetailsData> getItems() {
        return items;
    }

    public void setItems(ArrayList<UserDetailsData> items) {
        this.items = items;
    }
}
